...
#ifndef APPLICATIONS_DYMO_DYMO_H
#define APPLICATIONS_DYMO_DYMO_H
...
#include "applications/dymo/DYMO_OutstandingRREQList.h"
#include "applications/dymo/DYMO_RM_m.h"
#include "applications/dymo/DYMO_RREQ_m.h"
#include "applications/dymo/DYMO_RREP_m.h"
#include "applications/dymo/DYMO_AddressBlock.h"
#include "applications/dymo/DYMO_RERR_m.h"
#include "applications/dymo/DYMO_UERR_m.h"
#include "applications/dymo/DYMO_DataQueue.h"
#include "applications/dymo/DYMO_Timeout_m.h"
#include "applications/dymo/DYMO_TokenBucket.h"

//===========================================================================================
// class DYMO: implements the network layer to route incoming messages
//===========================================================================================
class DYMO : public cSimpleModule, public IP::Hook
{
	public:
		...
		/** @brief inherited from IP::Hook, called when a new inbound data packet is to be routed */
		virtual IP::Hook::Result datagramPreRoutingHook(const IPDatagram* datagram, const InterfaceEntry* inIE, const IP* ipLayer);

		/** @brief inherited from IP::Hook, called when a new outbound data packet is to be routed */
		virtual IP::Hook::Result datagramLocalOutHook(const IPDatagram* datagram, const InterfaceEntry* outIE, const IP* ipLayer);

		/** @brief inherited from IP::Hook, called when an outbound data packet is to be sent */
		virtual IP::Hook::Result datagramPostRoutingHook(const IPDatagram* datagram, const InterfaceEntry* inIE, const InterfaceEntry* outIE, const IPAddress& nextHopAddr, const IP* ipLayer);
	...
	private:
		...
		/** @brief bind UDP port for communication with lower layer */
