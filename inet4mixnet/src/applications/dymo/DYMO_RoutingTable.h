...
#ifndef APPLICATIONS_DYMO_DYMO_ROUTINGTABLE_H
#define APPLICATIONS_DYMO_DYMO_ROUTINGTABLE_H
...
#include "applications/dymo/DYMO_RoutingEntry.h"
...
{
	public:
		DYMO_RoutingTable(cModule* host, const IPAddress& myAddr, const char* DYMO_INTERFACES, const IPAddress& LL_MANET_ROUTERS);
	...
	private:
		...
		IRoutingTable* routingTable; /**< containing host's standard IRoutingTable module */
